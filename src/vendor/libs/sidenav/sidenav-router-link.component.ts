...
<a
  ...
  class="sidenav-link bg-light mb-1 text-white"
  
  [ngClass]="linkClass">
  <i class="sidenav-icon" *ngIf="icon" [ngClass]="icon"></i>
  <div><ng-content style="font: Regular 15px/19px Source Sans Pro !important; letter-spacing: 0; color: #F5F5F5; opacity: 1;"></ng-content></div>
